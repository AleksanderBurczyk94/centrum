...
export class PriceListComponent implements AfterViewInit, OnDestroy {
    ...
    if (isPlatformBrowser(this.platformId)) {
      this.popoverElements.forEach((popoverElement) => {
        const popover = new bootstrap.Popover(popoverElement.nativeElement, {
          ...
          placement: 'left',
          content:
            popoverElement.nativeElement.getAttribute('data-content') ||
      ...
      document.addEventListener(
        'click',
        this.closeAllPopovers.bind(this),
        true
      );
    }
  }
  ...
  services: PriceCard[] = [
    ...
    },
    {
      ...
      description:
        'Diagnoza obejmuje: wywiad z rodzicem, kwestionariusz sensomotoryczny, obserwację kliniczną dziecka, testy, obserwację spontanicznej zabawy, ustne omówienie diagnozy i zaleceń, plan ćwiczeń do domu i dodatkowe zalecenia.\n' +
    ...
    },
    {
      ...
      time: '50 min',
      description:
        'Terapia SI trwa 50 min. obejmujące ćwiczenia i omówienie zajęć z rodzicem. Polega na wykonywaniu przez dziecko specjalnie dobranych ćwiczeń i zabaw na sali integracji sensorycznej. Zajęcia przeprowadzane są indywidualnie dla każdego dziecka.',
    },
    {
      ...
      time: '50 min',
      description:
        'Terapia NeuroTaktylna MNRI® (Metoda Neuro-Sensoryczno-Refleksyjna) trwa 50 min. obejmujące stymulację taktylną i omówienie zajęć z rodzicem. Podczas zajęć dziecko leży, a terapeuta pracuje nad poprawą funkcjonowania układu nerwowego poprzez specjalne taktylne ruchy przypominające masaż.',
    },
    {
      name: 'Terapia ręki',
      price: '130 zł',
      time: '50 min',
      description:
        'Terapia ręki trwa 50 min. obejmujące ćwiczenia i omówienie zajęć z rodzicem. Polega na wykonywaniu przez dziecko specjalnie dobranych ćwiczeń i zadań, które poza stymulacją czucia głębokiego oraz pracą nad mięśniami posturalnymi, obejmuje również ćwiczenia małej motoryki.',
    },
    {
    ...
    },
    {
      ...
      time: '3x 50 min',
      description:
        'Diagnoza obejmuje: wywiad z rodzicem, kwestionariusz INPP, testy, ustne omówienie wyników, ćwiczenia do domu, stały kontakt z terapeutą w sprawie prawidłowo wykonywanych ćwiczeń w domu.',
    },
    {
      ...
      time: '50 min',
      description:
        'Terapia odruchów INPP w przeciwieństwie do terapii integracji sensorycznej jest terapią domową i ćwiczenia wykonywane są pod kontrolą rodzica. Spotkania kontrolne z terapeutą INPP odbywają się co minimum 8 tygodni.',
    },
    {
  ...
  documents = [
    {
      ...
      time: '',
      description:
        'Wydanie pisemnego dokumentu na prośbę rodzica zawierającego opis procesów przetwarzania sensorycznego dziecka na podstawie przeprowadzonej diagnozy.',
    },
    {
      ...
      time: '',
      description:
        'Wydanie pisemnej opinii na prośbę rodzica na temat funkcjonowania dziecka w ramach diagnozy INPP, która ocenia integrację odruchów pierwotnych i jej wpływ na rozwój.',
    },
    {
      name: 'Pisemna opinia',
      price: '50 zł',
      time: '50 min (zazwyczaj 3x 50 min)',
      description:
        'Wydanie pisemnej opinii na temat funkcjonowania dziecka na zajęciach/terapii/ postępów terapii do szkoły, przedszkola, poradni psychologiczno-pedagogicznej itd.',
    },
  ];
}
