    ...
    children: [
      {
        ...
        data: {
          description:
            'Pobierz formularz zgody na udział w terapii w Centrum Równowaga w Kaliszu. Wypełnij i zapewnij sobie profesjonalne wsparcie terapeutyczne.',
        },
      },
      {
        ...
        data: {
          description:
            'Formularz zgody na publikację wizerunku w Centrum Równowaga w Kaliszu. Zapewniamy pełną ochronę danych zgodnie z RODO.',
        },
      },
      {
        ...
        data: {
          description:
            'Zapoznaj się z zasadami ochrony małoletnich w Centrum Równowaga w Kaliszu. Sprawdź nasze standardy bezpieczeństwa i politykę RODO.',
        },
      },
    ],
  },
