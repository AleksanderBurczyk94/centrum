  ...
  cards: AssistanceCard[] = [
    {
      ...
      description:
        'Wsparcie psychologiczne dla dzieci, młodzieży i&nbsp;rodziców, pomoc w&nbsp;radzeniu sobie z&nbsp;emocjami, stresem, obniżoną samooceną, trudnościami relacyjnymi. Rozwijanie umiejętności społeczno-emocjonalnych, mindfullnes.',
    ...
    },
    {
      ...
      description:
        'Wsparcie dzieci z&nbsp;trudnościami ruchowymi i&nbsp;przetwarzania sensorycznego. Diagnoza i&nbsp;terapia integracji sensorycznej.',
    ...
    },
    {
      ...
      description:
        'Stymulacja i&nbsp;wygaszanie odruchów pierwotnych, poprawa umiejętności szkolnych, wsparcie neurorozwojowe, eliminacja choroby lokomocyjnej.',
    ...
    },
    {
      ...
      description:
        'Normalizacja pracy układu nerwowego, niwelowanie obronności dotykowej i&nbsp;niewystarczającej wrażliwości na&nbsp;bodźce sensoryczne.',
    ...
    },
    {
      ...
      description:
        'Wspomaganie rozwoju zdolności słuchowych i&nbsp;koncentracji, niwelowanie nadwrażliwości słuchowej, poprawa przetwarzania bodźców dźwiękowych.',
    ...
    },
    {
      ...
      description:
        'Terapia motoryki małej, poprawa nieprawidłowego chwytu pisarskiego, poprawa koordynacji ruchowej, sprawności manualnej i&nbsp;precyzyjnej, wspieranie samodzielności dziecka w&nbsp;codziennych czynnościach.',
    ...
    },
    {
      ...
      description:
        'Wsparcie edukacyjne dzieci z&nbsp;trudnościami w&nbsp;nauce, rozwój umiejętności szkolnych i&nbsp;społecznych. Terapia dostosowana do&nbsp;indywidualnych potrzeb dziecka.',
    ...
    },
    {
      ...
      description:
        'Indywidualne konsultacje dla&nbsp;rodziców w&nbsp;zakresie przetwarzania sensorycznego, rozwoju ruchowego i&nbsp;społeczno-emocjonalnego dzieci, w&nbsp;tym dzieci w&nbsp;spektrum autyzmu, ADHD, mutyzmu wybiórczego, niepełnosprawności intelektualnej.',
